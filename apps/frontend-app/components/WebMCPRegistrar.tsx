  ...
  useEffect(() => {
    ...
    async function registerAllTools() {
      try {
        ...
        console.log("[frontend-app] registered", deployFrontendTool.name);

        await document.modelContext!.registerTool(getFrontendTool, options);
        console.log("[frontend-app] registered", getFrontendTool.name);

        await document.modelContext!.registerTool(deleteFrontendTool, options);
        console.log("[frontend-app] registered", deleteFrontendTool.name);

        console.log("[frontend-app] all WebMCP tools registered");
        ...
        console.error("[frontend-app] tool registration failed:", err);
