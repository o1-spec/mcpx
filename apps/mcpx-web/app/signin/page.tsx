  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-accent-lime selection:text-background flex flex-col justify-between relative overflow-hidden">
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center p-4 sm:p-6">
        <div className="w-full max-w-97.5 border border-white/9 bg-panel p-7 sm:p-8 space-y-6 shadow-2xl rounded-sm">
          {/* Card Header */}
          ...
          {error && (
            <div className="p-3 bg-rose-950/30 border border-rose-500/30 text-rose-300 font-mono text-xs rounded">
              ✕ {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-3.5 py-2 rounded bg-background border border-white/9 text-xs font-sans text-foreground placeholder-subtle focus:outline-none focus:border-white/30 transition-colors"
                autoComplete="email"
                required
              />
            </div>
          ...
          <div className="space-y-3 pt-2">
            <div className="relative flex items-center justify-center">
              ...
              <span className="bg-panel px-2 text-xs font-mono text-subtle uppercase absolute">
                OR
              </span>
            </div>
            ...
            <button
              ...
              className="w-full py-2 px-4 rounded bg-background border border-white/9 text-foreground hover:bg-white/3 font-mono text-xs transition-colors cursor-pointer flex items-center justify-center gap-2"
            >
